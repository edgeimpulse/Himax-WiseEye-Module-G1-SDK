...
static volatile uint8_t g_wdma2_data[0] = {};
...
void app_main()
{
    ...
    while(1)
    {
        ...
        /* Capture raw (yuv) image */
        dbg_printf(DBG_LESS_INFO, "[app_dp_capture_raw_yuv_frame]\n");
        app_dp_capture_raw_yuv_frame(&app_dp_cap_set);

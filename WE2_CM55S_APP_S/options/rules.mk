...
.SECONDEXPANSION:
$(APPL_FULL_NAME).$(ELF_FILENAME) : $(ALL_GENERATED_DIRS_TMPFILES) $(DEVICE_OBJS) $(BOARD_OBJS) $(BSP_NODRIVER_ALLOBJS) $(DRIVERS_OBJS) $(INTEGRATE_OBJS) $(HWACCAUTOTEST_OBJS) $(SCENARIO_APP_OBJS) $(APPL_OBJS) $(TRUSTZONE_SEC_OBJS) $(TRUSTZONE_CFG_OBJS) $(NSC_OBJS) $(INTERFACE_OBJS) $(OS_ALLOBJS) $(OS_HAL_ALLOBJS) $(HMX_BSP_LIBS) $(AUDIOALGO_LIB) $(PRE_LINKER_SCRIPT_FILE) $$(COMMON_COMPILE_PREREQUISITES)
	$(TRACE_LINK)
	$(Q)$(LD) $(LINK_OPT) $(DEVICE_OBJS) $(BOARD_OBJS) $(INTEGRATE_OBJS) $(HWACCAUTOTEST_OBJS) $(BSP_NODRIVER_ALLOBJS) $(DRIVERS_OBJS) $(SCENARIO_APP_OBJS) $(APPL_OBJS) $(TRUSTZONE_SEC_OBJS) $(TRUSTZONE_CFG_OBJS) $(NSC_OBJS) $(INTERFACE_OBJS) $(OS_ALLOBJS) $(OS_HAL_ALLOBJS) $(LD_START_GROUPLIB) $(HMX_BSP_LIBS) $(AUDIOALGO_LIB) $(EXTRA_LIBS) $(LD_SYSTEMLIBS) $(LD_END_GROUPLIB) -o $@

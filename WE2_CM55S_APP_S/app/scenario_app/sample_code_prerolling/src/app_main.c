...
void app_main()
{
	...
	hx_drv_timer_hw_stop(TIMER_ID_4); /*TIMER_ID_4*/
	hx_drv_timer_hw_stop(TIMER_ID_5); /*TIMER_ID_5*/
	hx_drv_timer_hw_stop(TIMER_ID_6); /*TIMER_ID_6*/
	hx_drv_timer_hw_stop(TIMER_ID_7); /*TIMER_ID_7*/
	hx_drv_timer_hw_stop(TIMER_ID_8); /*TIMER_ID_8*/
